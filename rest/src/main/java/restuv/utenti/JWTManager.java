...
public class JWTManager {
    ...
    private static final String ISS = "it.vda.arpa";

    public String generate(Utente usr) {
    ...
    private JSONObject generateJWT(Utente usr) {
        long currentTimeInSecs = (System.currentTimeMillis() / 1000);
        long expirationTime = currentTimeInSecs + 1000000;
    ...
    private JSONArray loadGroups(Utente user) {
